...
MODULE_ACTIONS={
"dashboard":["view"],"children":["view","create","update","delete","export","import"],"children.documents":["view","upload","verify","delete","export"],"daily_attendance":["view","create","update","bulk_mark","delete","export"],"visitors":["view","create","update","delete","verify","block","export"],"child_visits":["view","create","update","delete","approve","reject","check_in","check_out","cancel","export"],"sponsors":["view","create","update","delete","export"],"sponsorships":["view","create","update","delete","cancel","export"],"accommodation":["view","create","update","delete","allocate","transfer","vacate","export"],"medical":["view","create","update","delete","export"],"education":["view","create","update","delete","export"],"case_management":["view","create","update","delete","close","export"],"development":["view","create","update","delete","submit","review","close","export"],"development.indicators":["view","manage"],"development.sensitive_notes":["view","create"],"development.ai_summary":["view","generate","update","review","approve","reject","delete","export","sensitive.view"],"reports":["view","export"],"imports":["view","upload","preview","commit"],"users":["view","create","update","deactivate","reset_password","assign_roles","export"],"roles":["view","create","update","delete","assign_permissions"],"audit_logs":["view","export"],"system_status":["view"]}
...
"Admin":["*"],
"Manager":[value for value in PERMISSION_CATALOG if not value.startswith(("users.","roles.","audit_logs.","development.indicators.manage","development.ai_summary.sensitive.view"))],
