...
export const navigation: NavGroup[] = [
  ...
  {label:"Development Profile",items:[{label:"Observations",href:"/dashboard/development/observations",roles:wardenOperational,permission:"development.view"},{label:"New Observation",href:"/dashboard/development/observations/new",roles:["Admin","Manager","Data Entry Operator","Warden","Counselor"],permission:"development.create"},{label:"AI Summaries",href:"/dashboard/development/ai-summaries",roles:["Admin","Manager","Counselor"],permission:"development.ai_summary.view"},{label:"Support Plans",href:"/dashboard/development/support-plans",roles:["Admin","Manager","Counselor","Warden"],permission:"development.support_plan.view"},{label:"Indicators",href:"/dashboard/development/indicators",roles:["Admin"],permission:"development.indicators.view"},{label:"Development Reports",href:"/dashboard/development/reports",roles:["Admin","Manager","Counselor"],permission:"development.export"}]},
