...
Branded PDFs include the organization logo or CCMS short-name fallback, organization name, address/contact line, report title, generated-by, generated-at, filters or period where applicable, organization footer text, `This report is system generated by CCMS.`, and page number.
...
- Existing sidebar routes were scanned for old Phase 9 placeholder copy.
- Destructive/status-changing module actions continue to use the existing confirmation modal path before submission.
