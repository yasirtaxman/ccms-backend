...
export const navigation: NavGroup[] = [
  ...
  {label:"Child Management",items:[
    {label:"Children",href:"/dashboard/children",roles:operational},
    {label:"Admission Documents",href:"/dashboard/admission-documents",roles:operational},
    {label:"Daily Attendance",href:"/dashboard/children/attendance",roles:operational},
    {label:"Attendance Reports",href:"/dashboard/children/attendance/reports",roles:operational},
    {label:"Import Children",href:"/dashboard/children/import",roles:["Admin","Manager","Data Entry Operator"]},
  ]},
  ...
  {label:"Case Management",items:["Case Profiles","Case Notes","Counseling","Incidents","Care Plans","Case Reviews"].map(label=>({label,href:`/dashboard/${label.toLowerCase().replaceAll(" ","-")}`,roles:operational}))},
