...
export interface AdmissionDocumentType {document_type:string;required:boolean;extensions:string[]}
export interface AdmissionChecklistItem {document_type:string;required:boolean;uploaded:boolean;verified:boolean;uploaded_count:number;latest_document_id:number|null;status:"Missing"|"Pending verification"|"Verified"}
