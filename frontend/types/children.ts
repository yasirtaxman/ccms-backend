...
export interface ChildCompleteProfile { child_basic:Record<string,unknown>;admission_documents:Record<string,unknown>;sponsorship:Record<string,unknown>;accommodation:Record<string,unknown>;medical:Record<string,unknown>;education:Record<string,unknown>;case_management:Record<string,unknown> }
